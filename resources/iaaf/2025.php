...
$mixedRelays = [
	'mixed_4x400m' => [
		'resultShift' => -400,
		'conversionFactor' => 0.02732,
		'pointShift' => 0,
	],
	'mixed_4x400m_short' => [
		'resultShift' => -405,
		'conversionFactor' => 0.02688,
		'pointShift' => 0,
	],
];
 ...
 *
 * Unlike the earlier editions there are no separate indoor and outdoor books —
 * the 2025 book is a single flat list of events. Events that score differently
 * on a short (200m) track have a separate entry with the `_short` suffix
 * (e.g. `200m` and `200m_short`). Events without a `_short` twin score the
 * same on any track.
 *
 * @type float $constants[gender][discipline]['resultShift']
 * @type float $constants[gender][discipline]['conversionFactor']
 * @type float $constants[gender][discipline]['pointShift']
 */
return [
	'm' => [
		'50m' => [
		...
		'25km' => [
			'resultShift' => -8640,
			'conversionFactor' => 0.0000638,
			'pointShift' => 0,
		],
		'30km' => [
			'resultShift' => -10600,
			'conversionFactor' => 0.0000419,
			'pointShift' => 0,
		],
		'marathon' => [
			'resultShift' => -15300,
			'conversionFactor' => 0.0000201,
			'pointShift' => 0,
		],
		'100km' => [
			'resultShift' => -48600,
	...
	'f' => [
		...
		'25km' => [
			'resultShift' => -13020,
			'conversionFactor' => 0.00001782,
			'pointShift' => 0,
		],
		'30km' => [
			'resultShift' => -15960,
			'conversionFactor' => 0.00001178,
			'pointShift' => 0,
		],
		'marathon' => [
			'resultShift' => -23400,
			'conversionFactor' => 0.00000539,
			'pointShift' => 0,
		],
		'100km' => [
			'resultShift' => -61200,
